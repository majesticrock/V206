...
\\ \\
\centerline{$a_1 =  6.320 \cdot 10^\text{$-6$} \frac{\symup{K}}{\symup{s}^2}$}
\centerline{$b_1 = -3.105 \cdot 10^\text{$-2$} \frac{\symup{K}}{\symup{s}}$}
\centerline{$c_1 =  298.7 \symup{K}$}
...
\begin{equation}
\label{eqt:mech-le}
  P_\text{mech} = \frac{1}{1 - \kappa} \bigg(p_b \cdot \sqrt[\kappa]{\frac{p_a}{p_b}} - p_a\bigg) \cdot \frac{T_2 p_0}{\rho_0 T_0 p_a} \frac{\symup{d}m}{\symup{d}t}
\end{equation}
